...
abstract class GenericBroadcastActivity extends AppCompatActivity {
  ...
  //var statusIconView: View = _ // may be deleted
  ...
  override def onCreate(savedInstanceState: Bundle): Unit = {
    ...
    //val avatarView = getLayoutInflater.inflate(R.layout.avatar_actionview, null) // may be deleted
  ...
  def getActiveMessageList(takeLast: Int): ArrayBuffer[Message] = {
    val db = State.db
    db.getBroadcastMessageList(takeLast = takeLast)
